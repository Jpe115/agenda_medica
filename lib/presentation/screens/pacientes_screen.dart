...
class PacientesScreenState extends ConsumerState<PacientesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final pacientesColor = ref.watch(colorListProvider)[2];
    final pacientesTheme = ThemeData(colorSchemeSeed: pacientesColor);
    ...
    return Theme(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: pacientesTheme.colorScheme.inversePrimary,
